      ...
      @endif
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <form action="{{ route('admin.uploadnews') }}" method="POST" enctype="multipart/form-data" id="form">
                @csrf
                <div class="form-group">
                    <label for="EventForm" class="title-edit" style="font-family: Nunito;">Masukkan Judul Berita :</label>
                    <input type="text" class="form-control bg-white" id="exampleInputEmail1" name="title" style="max-width: 40%;">
                </div>
                <div class="form-group">
                    <label for="EventForm" class="title-edit" style="font-family: Nunito;">Masukkan Deskripsi Berita :</label>
                    <input type="text" class="form-control bg-white" id="exampleInputEmail1" name="desc" style="max-width: 40%;">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="exampleInputFile" style="font-family: Nunito;" class="title-edit">Masukkan Gambar (16:9) :</label>
