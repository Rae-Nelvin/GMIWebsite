  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      @endif
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 h1-title" style="font-size: 60px;font-family: Nunito;">Photos</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active" style="font-size: 20px;color: #edc124;font-weight: bold;font-family: Nunito;">Photos</li>
              <br>
            </ol>
          </div><!-- /.col -->
        </div>
                    ...
                    <th class="column6">Actions</th>
                      ...
                      @foreach ($photo as $photos)
                        <tr class="table100-body">
                          ...
                          <td class="column2">{!! $photos['title'] !!}</td>
